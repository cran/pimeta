# Wald ML confidence interval for \eqn{\tau^2}
# 
# Returns a Wald confidence interval for \eqn{\tau^2}
# with ML estimator (Biggerstaff & Tweedie, 1997).
# 
# @name tau2h_wald_ml
# @rdname tau2h_wald_ml
...
# tau2h <- pimeta::tau2h_ml(sbp$y, sbp$sigmak)
# pimeta::tau2h_wald_ml(sbp$sigmak, tau2h)
# @export
tau2h_wald_ml <- function(se, tau2h, alpha = 0.05) {
